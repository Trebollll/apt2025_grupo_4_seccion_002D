                ...
                <form id="workerForm" class="space-y-6" method="POST" enctype="multipart/form-data" action="editarrefugio.php">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <textarea name="horario" rows="4" class="w-full px-4 py-2 border border-gray-300 bg-white text-black rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"><?= htmlspecialchars($refugio['horario']) ?></textarea>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">Redes Sociales</label>
                        <textarea name="redes_sociales" rows="4" class="w-full px-4 py-2 border border-gray-300 bg-white text-black rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"><?= htmlspecialchars($refugio['redes_sociales']) ?></textarea>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">Especies</label>
                        <textarea name="especies" rows="4" class="w-full px-4 py-2 border border-gray-300 bg-white text-black rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"><?= htmlspecialchars($refugio['especies']) ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="mapa_url" rows="4" class="w-full px-4 py-2 border border-gray-300 bg-white text-black rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"><?= htmlspecialchars($refugio['mapa_url']) ?></textarea>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">Descripción</label>
                        <textarea name="descripcion" rows="4" class="w-full px-4 py-2 border border-gray-300 bg-white text-black rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"><?= htmlspecialchars($refugio['descripcion']) ?></textarea>
                    </div>
