...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Crear nombre de archivo con fecha y RUT limpio
    ...
    $sql = "INSERT INTO mascotas (
            nombre, sexo, raza, estado_salud, especie, edad, nro_chip, tamaño, estado,  region_id, comuna_id, foto, refugio_id
        ) VALUES (
            '$nombre', '$sexo', '$raza', '$estado_salud', '$especie', " . ($edad !== "" ? $edad : "NULL") . ", '$nro_chip', 
            '$tamaño', '$estado', '$region_id', '$comuna_id', " . ($foto ? "'$foto'" : "NULL") . ", '$refugio_id'
        )";
...
<head>
  <meta charset="UTF-8">
  <title>Crear perfil de Mascota</title>
    ...
    <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto bg-white border border-gray-300 shadow-[0_4px_10px_rgba(0,0,0,0.1)] rounded-2xl p-8 transition-all duration-300">
            <div class="mb-8 text-center">
                <h1 class="text-3xl font-bold text-gray-900">Crear perfil de Mascota</h1>
                ...
                <?php endif; ?>
                <form id="workerForm" class="space-y-6" method="POST" enctype="multipart/form-data" action="">
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group">
                      ...
                      <select id="sexo" name="sexo" class="w-full px-4 py-1 border border-gray-300 bg-white text-black rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out">
                    ...
                    <div>
                        ...
                        <input type="text" id="especie" name="especie" class="w-full px-4 py-1 border border-gray-300 bg-white text-black rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out" required>
                    </div>

                    <div>
                        <label for="raza" class="block text-sm font-medium text-gray-700">Raza</label>
                        <input type="text" id="raza" name="raza" class="w-full px-4 py-1 border border-gray-300 bg-white text-black rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out" required>
                    </div>

                    <div>
                        <label for="estado_salud" class="block text-sm font-medium text-gray-700">Estado de Salud</label>
                        <input type="text" id="estado_salud" name="estado_salud" class="w-full px-4 py-1 border border-gray-300 bg-white text-black rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="nro_chip" name="nro_chip" class="w-full px-4 py-1 border border-gray-300 bg-white text-black rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out" required>
                    </div>

                    <div>
                        <label for="tamaño" class="block text-sm font-medium text-gray-700">Tamaño</label>
                        <input type="text" id="tamaño" name="tamaño" class="w-full px-4 py-1 border border-gray-300 bg-white text-black rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out" required>
                    </div>
